...
center_x = int(width / 2 - 900 / 2)
center_y = int(height / 2 - 550 / 2)
windows.geometry(f"900x550+{center_x}+{center_y}")
db = Database()


# odam = ImageTk.PhotoImage(file="photo_2024-03-11_23-59-15 (1).jpg")
# odam_label = Label(windows, image=odam)
# odam_label.grid(row=1, column=2)
